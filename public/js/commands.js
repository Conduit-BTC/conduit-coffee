...
banner = [
  `<div class="pt-2"><span class="text-[#ffea00] ">Coffee time! — Type <span class="command text-[#75e1e7]">help</span> for a list of supported commands.</span>
  <br><span>class</span> <span class="text-[#ffea00]">LightningRoast</span> : DarkRoast {
    <br>  string Description = "This shit's the BOMB!"
    <br>  number Weight = 12 // oz
    <br>
    <br>  bool ShouldIBuyIt = true
    <br>
    <br>  AddToCart() {
    <br>    // > Click Here! < //
    <br>  }
