...
export const DeliveryTimesMessage = () => {
    return (
        <>
            ...
            <div className='mb-4'>
                {`We are a small company, and we're just getting started. We have enough stock on-hand to fulfill our expected sales volume. However, if we’re more-popular than expected, your order may be delayed by up to 2 weeks. This is because we must order beans, bags, labels, and packing materials, then ship them out to you.`}
            </div>
            ...
            <div>{`You’re supporting a brand-new Nostr Lightning project, and we thank you immensely for your patience.`}</div>
        </>
    );
};
