...
exports.createPointOfSaleOrder = async (req, res) => {
  // See https://docs.strike.me/walkthrough/receiving-payments
  console.log('Creating Point-of-Sale Order...');
  ...
  try {
    ...
    const usdShippingCost = 0;
    const satsShippingCost = 0;

    const createdOrder = await prisma.order.create({
      data: {
        first_name: 'POS_ORDER',
        last_name: 'POS_ORDER',
        address1: 'POS_ORDER',
        address2: 'POS_ORDER',
        zip: 'POS_ORDER',
        special_instructions: 'POS_ORDER',
        email: 'POS_ORDER',
        cart: {
          create: {
